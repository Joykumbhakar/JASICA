...
imports = """import { 
  ...
  Wind, Fan, Code, Droplet, SmartphoneCharging, SquarePlay, Instagram,
  Facebook, Linkedin, Music, Camera, Paintbrush, Check, Globe,
                          ...
                          <div className="flex flex-col px-4 py-3">
                              ...
                              <div className="flex items-center gap-3 w-full max-w-md mx-auto">
                                  ...
                                  <div className="flex-1 h-1 bg-zinc-200 rounded-full relative">
                                      ...
                                      <div class="absolute left-[85%] top-1/2 -translate-y-1/2 w-4 h-4 bg-white border border-zinc-300 rounded-full"></div>
                                  </div>
