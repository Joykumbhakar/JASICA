...
export default function HomePage() {
  ...
  return (
    ...
    <div className="absolute top-[22vh] -mt-[5px] sm:mt-0 sm:top-[20vh] md:top-[18vh] left-0 w-full px-4 text-center z-0 pointer-events-none flex flex-col items-center">
        <h1 className="mobile-title-scale text-[28.525rem] sm:text-[9rem] md:text-[12rem] lg:text-[16rem] font-bold tracking-apple-tighter leading-[0.8] animate-fade-up pb-2 whitespace-nowrap">
