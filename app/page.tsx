...
export default function HomePage() {
  ...
  return (
    ...
    <div className="absolute top-[22vh] mt-[50px] sm:mt-0 sm:top-[20vh] md:top-[18vh] left-0 w-full px-4 text-center z-0 pointer-events-none flex flex-col items-center">
